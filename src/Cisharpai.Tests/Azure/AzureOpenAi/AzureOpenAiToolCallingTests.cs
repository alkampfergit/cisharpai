...
public sealed class AzureOpenAiToolCallingTests
{
    ...
    private static AzureOpenAiClientOptions CreateOptions() =>
        new() { DeploymentName = DeploymentName, ApiKey = "test-key", Endpoint = "https://test.openai.azure.com/" };
    ...
    #region Endpoint/Header Verification Tests
    ...
    public async Task ToolCalling_UsesCorrectEndpoint()
    {
        ...
        Assert.That(capturedUri!.PathAndQuery, Does.Contain($"openai/deployments/{DeploymentName}/chat/completions"));
